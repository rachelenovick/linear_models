...
Does a decent job for the bulk of the data, but at the low end of weight the prediction line is not through center of data. Linear models are EASY to interpret.
...
^Looks similar to piece-wise, but smoothed out. Harder to interpret than linear.
...
Linear model has a higher distribution of higher rmse. Smooth and pwl seem to perform similarly. But tbh, all of them perform relatively similary, and you could justify why you prefer each of them most. Might come down to interpretation.
